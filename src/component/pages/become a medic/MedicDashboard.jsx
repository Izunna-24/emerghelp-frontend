...
function MedicDashboard() {
    ...
    return (
        ...
        <div className="flex min-h-screen">
            <aside className="w-64 bg-red-600  w-80 text-white">
                ...
                <nav>
                    <ul>
                        ...
                        <h1 className="text-xl font-bold">Izu</h1>
                        ...
                        <li className="p-4 hover:bg-gray-700">
                            <a href="/messageMedic" className="flex items-center text-lg">
                                <span
                                    className="mr-2 text-xl"><FaSms/></span>
                                Message Patient
                            </a>
                        </li>
                ...
                <header className="bg-white shadow p-4 flex justify-between items-center">
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <input
                            type="text"
                            placeholder="Search..."
                            className="w-sm p-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-red-600"
                        />
                        <div className="bg-white p-1 rounded-sm ">
                            <h2 className="text-lg font-semibold">Language</h2>
                            <select
                                className="max-w-sm  rounded-lg border-gray-300  focus:ring-2 focus:ring-red-600">
                ...
                <div className="bg-white p-4 rounded-lg shadow flex justify-between">
                    <div>
                        ...
                        <ul className="mt-4 space-y-3">
                            <li className="text-gray-700 text-1xl">Called Dr. Smith - 2 hours ago</li>
                            <li className="text-gray-700 text-1xl">Medication Reminder - 4 hours ago</li>
                            <li className="text-gray-700 text-1xl">Logged in - 1 day ago</li>
                        </ul>
                    </div>
                </div>
