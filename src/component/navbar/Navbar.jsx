        ...
        <nav className="fixed top-0 left-0 w-full bg-white shadow-md z-50">
            <div className="flex justify-between items-center p-4 max-w-7xl mx-auto">
                ...
                <div className="hidden md:flex items-center space-x-10">
                    <div className="hover:text-black cursor-pointer text-black">Home</div>
                    <div className="hover:text-black cursor-pointer text-black">Accept Order</div>
                    <div className="hover:text-black cursor-pointer text-black">Order Medic</div>
                    <div className="hover:text-black cursor-pointer text-black">Payment</div>
                    <div className="hover:text-black cursor-pointer text-black" onClick={handleAboutUsClick}>About Us</div>
                    <div className="hover:text-black cursor-pointer text-black" onClick={handleResponseTeamClick}>Response Team</div>
                    <button
